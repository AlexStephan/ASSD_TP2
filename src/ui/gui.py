...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 318, 360))
        ...
        self.horizontalLayout_synthesize_currentEffectSettings.addLayout(self.verticalLayout_7)
        self.verticalLayout_4.addLayout(self.horizontalLayout_synthesize_currentEffectSettings)
        ...
        self.doubleSpinBox_spectrogram_plot = QtWidgets.QDoubleSpinBox(self.tab_spectrogram)
        self.doubleSpinBox_spectrogram_plot.setMinimumSize(QtCore.QSize(115, 0))
        self.doubleSpinBox_spectrogram_plot.setMaximumSize(QtCore.QSize(115, 16777215))
        self.doubleSpinBox_spectrogram_plot.setObjectName("doubleSpinBox_spectrogram_plot")
        self.horizontalLayout_13.addWidget(self.doubleSpinBox_spectrogram_plot)
        ...
        self.spinBox = QtWidgets.QSpinBox(self.tab_spectrogram)
        self.spinBox.setMinimumSize(QtCore.QSize(115, 0))
        self.spinBox.setMaximumSize(QtCore.QSize(115, 16777215))
        self.spinBox.setMinimum(1)
        self.spinBox.setMaximum(999999999)
        self.spinBox.setProperty("value", 1024)
        self.spinBox.setObjectName("spinBox")
        self.horizontalLayout_24.addWidget(self.spinBox)
        ...
        self.spinBox_2 = QtWidgets.QSpinBox(self.tab_spectrogram)
        self.spinBox_2.setMinimumSize(QtCore.QSize(115, 0))
        self.spinBox_2.setMaximumSize(QtCore.QSize(115, 16777215))
        self.spinBox_2.setMinimum(0)
        self.spinBox_2.setMaximum(999999999)
        self.spinBox_2.setProperty("value", 512)
        self.spinBox_2.setObjectName("spinBox_2")
        self.horizontalLayout_25.addWidget(self.spinBox_2)
        ...
        self.comboBox_15 = QtWidgets.QComboBox(self.tab_spectrogram)
        self.comboBox_15.setMinimumSize(QtCore.QSize(115, 0))
        self.comboBox_15.setMaximumSize(QtCore.QSize(115, 16777215))
        ...
        self.comboBox_15.addItem("")
        self.comboBox_15.addItem("")
        self.horizontalLayout_26.addWidget(self.comboBox_15)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 457, 606))
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_15.setItemText(1, _translate("Form", "Bartlett"))
        self.comboBox_15.setItemText(2, _translate("Form", "Hanning"))
        self.comboBox_15.setItemText(3, _translate("Form", "Hamming"))
        self.comboBox_15.setItemText(4, _translate("Form", "Blackman"))
        self.comboBox_15.setItemText(5, _translate("Form", "Blackman-Harris"))
